...
<div class="w-full container my-24 px-6 mx-auto">
    ...
    <section class="mb-32 text-gray-800">
      <div class="flex flex-wrap">
        ...
        <div wire:offline class="text-gray-400 bg-gray-300">
            You are now offline.
        </div>
          <form wire:submit.prevent="subscribe"> 
            <p class="my-4 text-red-400">@error('name') {{ $message }} @enderror</p>
            ...
            <div class="form-group mb-6"> 
              <p class="my-4 text-red-400">@error('email') {{ $message }} @enderror</p>
              <input 
                wire:model="email" 
                type="email" 
                class="form-control block
            ...
            <div class="form-group mb-6"> 
                <p class="my-4 text-red-400">@error('message') {{ $message }} @enderror</p>
              <textarea 
                wire:model="message" 
                class="
                    form-control
        ...
        <button type="button" wire:click="name_field_is_required_for_saving_a_contact" class="w-md py-2 px-4 bg-blue-400 text-white rounded-md m-6">Save</button>
      </div>
    </section>
    <!-- Section: Design Block -->
